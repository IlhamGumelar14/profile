      ...
      <div className="w-full md:flex gap-2">
        <div className="w-full md:w-1/2 md:p-4">
          <div className="w-full h-full">
            <div className="relative w-full h-[30rem] overflow-hidden">
              <Fade bottom>
                <div className="absolute border border-radius-50 w-full h-80 md:flex bg-yellow-500">
                  <img
                    src={User}
                    alt="Profile"
                    className="w-[60%] md:scale-100 scale-65 object-justify object-cover mx-auto grayscale"
                  />
                </div>
              </Fade>
            </div>
        ...
        <div className="w-full md:w-1/2 md:p-4">
          <div className="w-full mt-4 mb-2 overflow-hidden">
            <Fade bottom>
              <h1 className="text-3xl font-semibold">I am Ilham</h1>
              <h2 className="text-xl font-medium">
                Front-end Developer from Bogor, Indonesia
              </h2>
            </Fade>
          </div>
          <Fade bottom>
